/**
 * Created by niushuai on 2018/6/26.
 */

$(function(){
  // 1 一进入页面,发送ajax请求.获取数据,进行页面渲染
...
$('#addBtn').click(function (){
  ...
  // 3 发送ajax 请求,获取下拉彩电的数据,进行渲染下拉菜单
  $.ajax({
    type:'get',
  ...
  // 3 给 dropdown-menu 注册委托事件, 让a 可以被点击
  ...
  $('#form').bootstrapValidator({
    ...
    // 默认不校验隐藏域的input 重置excluded 为[] 恢复对隐藏域的校验
    excluded:[],
